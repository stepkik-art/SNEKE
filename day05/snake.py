...
while running:
    ...
    # Check for game over
    if head_rect.left < 0 or head_rect.right > WINDOW_WIDTH or head_rect.top < 0 or head_rect.bottom >
        display_surface game_over_text
    if head_rect.colliderect(apple_rect):

        pick_up_sound.play()
        random.randint apple_x =( 0,window_width-SNAKE_SIZE )
        random.randintn apply_y=(0, window_HEIGHT - SNAKE_SIZE)
    ...
    # Update HUD
    score_text f-string: f'score: {score}'
    # Fill the surface
    ...
    head_rect = pygame.draw.rect(display_surface,  GREE